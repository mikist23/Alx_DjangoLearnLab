...
SECRET_KEY = 'django-insecure-tz($x4s+q#2p%f2n$o8j4jnjn64j1ytgj42$x8j!(u1d-&n8&$'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.TokenAuthentication',    # For token-based auth (if needed)
    ],
